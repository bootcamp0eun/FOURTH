...
public class SimpleEchoClient {
    public static void main(String[] args) {
        ...
        try {
            InetAddress localAddress = InetAddress.getLocalHost();   // 127.0.0.1 을 가져오는 것이다
            // 다른 사람 컴터 -> localAddress 말고 IP 주소 입력하면 됨
            ...
            try {
                ...
                while (true) {
                    ...
                    if ("exit".equalsIgnoreCase(line) || "종료".equalsIgnoreCase(line)) {
                        break;  // 종료조건
                    }
